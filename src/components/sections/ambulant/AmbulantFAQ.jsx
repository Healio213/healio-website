...
const faqsVertrauen = [
  ...
  { q: "Ist Healio seriös? Kann ich den Erfahrungen vertrauen?", a: "Healio ist als Versicherungsmakler nach §34d GewO zugelassen und im Vermittlerregister eingetragen. Wir unterliegen der Aufsicht der IHK Hamburg und sind an strenge Beratungsstandards gebunden. Über 5.000 Kunden nutzen bereits das Healio Konzept mit einer durchschnittlichen Bewertung von 4,9 von 5 Sternen. Die SDK und die IKK Classic sind beide von der BaFin (Bundesanstalt für Finanzdienstleistungsaufsicht) reguliert." },
