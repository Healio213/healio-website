...
const faqsLeistungen = [
  ...
  { q: "Was passiert, wenn ich den IKK-Bonus nicht voll ausschöpfe?", a: "Die SDK-Zusatzversicherung funktioniert unabhängig vom Bonus. Du bekommst deine Leistungen in jedem Fall. Der IKK-Bonus ist ein zusätzlicher Vorteil, der deine effektiven Kosten senkt — aber nicht Voraussetzung für den Versicherungsschutz." },
];
...
const faqsVertrauen = [
  ...
  { q: "Ist Healio ein Versicherungsunternehmen?", a: "Nein. Healio ist ein unabhängiger Versicherungsmakler nach §34d GewO. Wir vermitteln Tarife der SDK (Süddeutsche Krankenversicherung), einem Versicherungsverein auf Gegenseitigkeit mit über 95 Jahren Erfahrung. Dein Vertrag besteht direkt mit der SDK." },
