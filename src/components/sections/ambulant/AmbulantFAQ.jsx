...
const faqs = [
  ...
  { q: "Was ist Healio genau und wie unterscheidet es sich von anderen Anbietern?", a: "Healio ist ein unabhängiger Versicherungsmakler aus Hamburg, gegründet von Frank Steinfurt. Im Gegensatz zu einzelnen Versicherungsanbietern kombiniert Healio die SDK Zusatzversicherung mit dem IKK Classic Bonusprogramm zu einem einzigartigen Gesundheitsbudget von bis zu 2.500 Euro in zwei Jahren. Das Ergebnis: Privatpatientenstatus im ambulanten Bereich, effektiv für 0 Euro." }
];
