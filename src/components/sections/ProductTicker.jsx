...
const tickerSets = {
  ambulant: [
    ...
    { icon: Stethoscope, key: 'ticker.video' },
  ],
  home: [
    { icon: Zap, key: 'ticker.bonusCheck' },
    { icon: ShieldCheck, key: 'ticker.threeAreas' },
    { icon: WalletCards, key: 'ticker.healthBudget' },
    { icon: BadgeCheck, key: 'ticker.independent' },
    { icon: HeartPulse, key: 'ticker.ongoingService' },
  ],
  leistungen: [
    { icon: ShieldCheck, key: 'ticker.threeAreas' },
    { icon: CheckCircle2, key: 'ticker.notEverything' },
    { icon: HeartPulse, key: 'ticker.needsFirst' },
    { icon: BadgeCheck, key: 'ticker.clearConditions' },
    { icon: Stethoscope, key: 'ticker.personalSupport' },
  ],
  about: [
    { icon: BadgeCheck, key: 'ticker.broker' },
    { icon: Building2, key: 'ticker.hamburg' },
    { icon: HeartPulse, key: 'ticker.threeAudiences' },
  ...
  unternehmen: [
    ...
    { icon: HeartPulse, key: 'ticker.ongoing' },
    { icon: Stethoscope, key: 'ticker.contact' },
  ],
  contact: [
    { icon: Stethoscope, key: 'contactTicker.personal' },
    { icon: Building2, key: 'contactTicker.hamburg' },
    { icon: HeartPulse, key: 'contactTicker.channels' },
    { icon: CheckCircle2, key: 'contactTicker.form' },
    { icon: Zap, key: 'contactTicker.response' },
  ],
  terminvereinbarung: [
    ...
    { icon: Stethoscope, key: 'appointmentTicker.personal' },
  ...
  zahn: [
    ...
    { icon: Stethoscope, key: 'ticker.check' },
  ],
  stationaer: [
    ...
    { icon: HeartPulse, key: 'ticker.accidentCover' },
  ...
  partner: [
    ...
    { icon: Stethoscope, key: 'ticker.healioAdvice' },
    { icon: BadgeCheck, key: 'ticker.freeParticipation' },
    { icon: HeartPulse, key: 'ticker.directContact' },
  ],
  zahnaerzte: [
