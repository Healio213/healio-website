...
const SEOHead = ({ 
  ...
  const defaultTitle = 'Healio - Ganzheitliche Gesundheit & Bonusoptimierung';
  const defaultDescription = 'Healio revolutioniert Gesundheit durch intelligente Bonusoptimierung. Maximiere deine Gesundheitsvorteile mit unserem innovativen Konzept.';
