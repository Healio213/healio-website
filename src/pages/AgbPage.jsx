        ...
        <div className="healio-container">
          <div className="prose prose-lg mx-auto text-healio-text-light max-w-4xl">
            ...
            <nav aria-label={t('impressum.breadcrumb')} className="mb-8 text-sm">
              ...
              {' / '}
              <Link to={getPath('impressum')} className="text-healio-green hover:underline">{t('impressum.title')}</Link>
              {' / '}
              <Link to={getPath('datenschutz')} className="text-healio-green hover:underline">{t('datenschutz.title')}</Link>
            </nav>

            <p className="text-healio-text-light mb-8">{t('agb.subtitle')}</p>

            <h2 className="text-2xl font-bold text-healio-text mt-12 mb-4">{t('agb.section1Title')}</h2>
            ...
            <h2 className="text-2xl font-bold text-healio-text mt-12 mb-4">{t('agb.section2Title')}</h2>
            ...
            <h2 className="text-2xl font-bold text-healio-text mt-12 mb-4">{t('agb.section3Title')}</h2>
            ...
            <p className="mt-12 text-sm text-gray-500">{t('agb.lastUpdated')}</p>
          </div>
        </div>
      </main>
    </>
