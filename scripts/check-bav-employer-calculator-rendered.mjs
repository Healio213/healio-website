...
assert.match(de, /monatliche 4-%-Modellauszahlung vor Abgaben/);
assert.match(de, /3\.174(?:&nbsp;|\u00a0)€/);
assert.match(de, /2\.222(?:&nbsp;|\u00a0)€/);
assert.match(de, /keine garantierte oder lebenslange Tarif-Rente/i);
assert.match(de, /Bundesfinanzministerium · Leistungsphase/);
assert.match(de, /§ 229 SGB V · Versorgungsbezüge/);
...
assert.match(en, /monthly 4% model withdrawal before deductions/);
assert.match(en, /€3,174/);
assert.match(en, /€2,222/);
assert.match(en, /not a guaranteed or lifelong tariff pension/i);
assert.match(en, /Federal Ministry of Finance · benefit phase/);
assert.match(en, /Section 229 SGB V · pension benefits/);
